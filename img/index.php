...
<html lang="uk">
  <head>
    ...
    <title>Кухні на замовлення Львів ціна за мій проект по фото GV-kuhni
    </title>
    ...
    <section class="bg100 benefits">
      ...
      <div class="bl2 left">
        <div class="box2 text fadeInRight wow">
          ...
          <p>
            <b>Ви ж оберете з майже 500 відтінків, 10 видів фасадів, сотень варіантів ручок та петель - лише те, що до вподоби особисто Вам.
            </b>
          </p>
        </div>
      </div>
        ...
        <div class="box2 text fadeInLeft wow">
          ...
          <ul>
            <li>можливо, 
              ...
              </b> площею біля 500 м2 та відсутність посередників
            </li>
            <li>вірогідно, багаторічна співпраця та 
              <b>ексклюзивні знижки від виробників фурнітури
              </b>
            </li>
            <li>напевно - досвід, завдяки якому ми порадимо 
              <b>де можна заощадити, а де не варто
              </b>
            </li>
          </ul>
      </div>
    ...
    <div class="bl2">
      <div class="box2 text fadeInRight wow">
        ...
        <p>
          <b>Ми виготовимо будь-які меблі для Вашої квартири у тому ж стилі: шафи-купе, столи, полиці і усе, що знадобиться.
          </b>
        </p>
      </div>
    </div>
  ...
  <section class="box100 gallery">
    <div class="box90">
      ...
      <div class="owl-carousel owl-theme owl-objects" itemscope itemtype="http://schema.org/ImageGallery">
        <div itemprop="associatedMedia" itemscope itemtype="https://schema.org/MediaObject"> 
          <a href="object1_lemkivska.php">
            <div class="object" itemscope itemtype="https://schema.org/image" style="background: url(./images/g1/1.jpg) center; background-size: cover">
              <meta itemprop="src" content="./images/g1/1.jpg" /> 
            </div>
        ...
        <div itemprop="associatedMedia" itemscope itemtype="https://schema.org/MediaObject">
          <a href="object2_britain.php">
            <div class="object" itemscope itemtype="https://schema.org/image" src="./images/g2/1.jpg" style="background: url(./images/g2/1.jpg) center; background-size: cover">
            </div>
            <span class="button">Більше фото</span>
          </a>
        </div>
        <div itemprop="associatedMedia" itemscope itemtype="https://schema.org/MediaObject">
          <a href="object3_khmelnytskyi.php">
            <div class="object" itemscope itemtype="https://schema.org/image" src="./images/g3/1.jpg" style="background: url(./images/g3/1.jpg) center; background-size: cover">
            </div>
            <span class="button">Більше фото</span>
          </a>
        </div>
        <div itemprop="associatedMedia" itemscope itemtype="https://schema.org/MediaObject">
          <a href="object4_kalyna.php">
            <div class="object" itemscope itemtype="https://schema.org/image" src="./images/g4/1.jpg" style="background: url(./images/g4/1.jpg) center; background-size: cover">
            </div>
            <span class="button">Більше фото</span>
          </a>
        </div>
        <div itemprop="associatedMedia" itemscope itemtype="https://schema.org/MediaObject">
          <a href="object5_yavor.php">
            <div class="object" itemscope itemtype="https://schema.org/image" src="./images/g5/1.jpg" style="background: url(./images/g5/1.jpg) center; background-size: cover">
            </div>
            <span class="button">Більше фото</span>
          </a>
        </div>
        <div itemprop="associatedMedia" itemscope itemtype="https://schema.org/MediaObject"> 
          <a href="object6_upa.php">
            <div class="object" itemscope itemtype="https://schema.org/image" src="./images/g6/1.jpg" style="background: url(./images/g6/1.jpg) center; background-size: cover">
            </div>
            <span class="button">Більше фото</span>
          </a>
        </div>
        <div itemprop="associatedMedia" itemscope itemtype="https://schema.org/MediaObject">
          <a href="object7_peremoha.php">
            <div class="object" itemscope itemtype="https://schema.org/image" src="./images/g7/1.jpg" style="background: url(./images/g7/1.jpg) center; background-size: cover">
            </div>
            <span class="button">Більше фото</span>
          </a>
        </div>
        <div itemprop="associatedMedia" itemscope itemtype="https://schema.org/MediaObject">
          <a href="object8_sokalska.php">
            <div class="object" itemscope itemtype="https://schema.org/image" src="./images/g8/1.jpg" style="background: url(./images/g8/1.jpg) center; background-size: cover">
            </div>
            <span class="button">Більше фото</span>
          </a>
        </div>
        <div itemprop="associatedMedia" itemscope itemtype="https://schema.org/MediaObject">
          <a href="object9.php">
            <div class="object" itemscope itemtype="https://schema.org/image" src="./images/g9/1.jpg" style="background: url(./images/g9/1.jpg) center; background-size: cover">
            </div>
            <span class="button">Більше фото</span>
          </a>
        </div>
        <div itemprop="associatedMedia" itemscope itemtype="https://schema.org/MediaObject">
          <a href="object10_sokilnyky.php">
            <div class="object" itemscope itemtype="https://schema.org/image" src="./images/g10/1.jpg" style="background: url(./images/g10/1.jpg) center; background-size: cover">
            </div>
            <span class="button">Більше фото</span>
          </a>
        </div>
        <div itemprop="associatedMedia" itemscope itemtype="https://schema.org/MediaObject"> 
          <a href="object11_dobryachyn.php">
            <div class="object" itemscope itemtype="https://schema.org/image" src="./images/g11/1.jpg" style="background: url(./images/g11/1.jpg) center; background-size: cover">
            </div>
            <span class="button">Більше фото</span>
          </a>
        </div>
        <div itemprop="associatedMedia" itemscope itemtype="https://schema.org/MediaObject">
          <a href="object12_zubeiky.php">
            <div class="object" itemscope itemtype="https://schema.org/image" src="./images/g12/1.jpg" style="background: url(./images/g12/1.jpg) center; background-size: cover">
            </div>
            <span class="button">Більше фото</span>
          </a>
        </div>
        <div itemprop="associatedMedia" itemscope itemtype="https://schema.org/MediaObject">
          <a href="object13_rudno.php">
            <div class="object" itemscope itemtype="https://schema.org/image" src="./images/g13/1.jpg" style="background: url(./images/g13/1.jpg) center; background-size: cover">
            </div>
            <span class="button">Більше фото</span>
          </a>
        </div>
        <div itemprop="associatedMedia" itemscope itemtype="https://schema.org/MediaObject">
          <a href="object14_zhvyrka.php">
            <div class="object" itemscope itemtype="https://schema.org/image" src="./images/g14/1.jpg" style="background: url(./images/g14/1.jpg) center; background-size: cover">
            </div>
            <span class="button">Більше фото</span>
          </a>
        </div>
      ...
      <div class="owl-carousel owl-theme owl-feed">
        ...
        <div> 
          ...
          <div class="feature">
            ...
            <div class="featuretext">«Дякую Вам за гарну кухню і решту меблів. Хороші підказки дизайнера, акуратна робота монтажників, стислі строки виконання. <br><br>За комплексне замовлення, надали гарну знижку))) Нам усе сподобалось. Рекомендую!»</div>
        ...
        <div> 
          ...
          <div class="feature">
            ...
            <div class="featuretext">«Дякую хлопцям за гарну роботу!!! Зверталась за рекомендацією друзів і залишилась задоволена. Втілили мрію в реальність. Ідеальне співвідношення ціни і якості. Так тримати!!»</div>
    ...
    <div class="contacts-modal-block modal__block">        
      <form class="form-contacts form">
        ...
        <p>            
          ...
          <input type="submit" value="Домовитися про час" onclick="ga('send', 'event', 'office', 'visit')">
        </p>
  ...
  <section class="box100 ps">
    <div style="max-width: 1200px;margin: 0 auto;text-align: left;padding: 0 0 30px 0 ">
      ...
      <p>
        <span>Загальна площа, чи точніше погонний метр, це стандартне мірило будь-якого виробника меблів. Більший розмір – більша ціна.
        </span>
      </p>
      <h4>
        <span>Матеріал виготовлення
        </span>
      </h4>
      <p>
        <span>Це найлегший спосіб виробнику ввести Вас в оману. Якщо ви побачите гарну кухню потрібних Вам розмірів за дуже низькою ціною, не вірте у дива. Неякісні матеріали, це першопричина короткого терміну служби. Ми також виготовляємо дешеві кухні на замовлення, проте ви точно знатимете за що платите.
        </span>
      </p>
      <h4>
        <span>Механізми та фурнітура
        </span>
      </h4>
      <p>
        <span>Ще один момент на котрому можуть зекономити, проте він дуже важливий, адже використовується найактивніше. Ми порадимо найкращий варіант, аби користування кухнею тривало якомога довше.
        </span>
      </p>
      <p>
        <span>Якщо ви вирішите все-таки кухні купити у готовому варіанті, то втратите цю пластичність формування ціни. Також замовити кухню варто тоді, коли є нестандартне планування кімнати, чи цікаве дизайнерське рішення, котре не дозволить задовольнити потребу пересічним асортиментом кухонь наших магазинів чи сайтів.
        </span>
      </p>
      <p>
