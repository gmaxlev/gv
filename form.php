...
<head>
  ...
  <title>Розрахунок вартості кухні. Ціна кухні по розмірах. Кухня по готовому проекту.</title>
...
<header class="header">
        ...
        <nav>
            ...
            <ul>
                ...
                <li class="active"><a href="/form.php"><span>Розрахунок вартості</span></a></li>
...
<section id="bg100" class="formheader"> <div id="box90">
<div class="left"><h2>Розрахуйте вартість кухні за 5 хвилин</h2>
<h5>Або надішліть готовий проект, щоб переконатися - ми робимо дешевше</h5></div>
                <a href="#" class="header__content-completed-project button">У мене є готовий проект</a>
</div></section>
 ...
 <main class="questions">
        <div class="container">
            <div class="question question--first active">
                ...
                <div class="question__toggle-block">
                    ...
                    <div class="question__buttons">
                        <a class="question__buttons-next"><span>Далі</span></a>
                    </div>
                </div>
            </div>
            ...
            <div class="question question--second">
                <div class="question__title-block">
                    <p>2. Введіть розміри кухні по стінах</p>
                    <div></div>
                </div>
                <div class="question__toggle-block">
                    <div class="question__block">
                        <div class="question__block-sizes" id="pryama">
                            <label id="label-q2_1">
                                <input type="text" class="q2_1" name="q2_1"><span> см</span>
                            </label>
                            <div>
                                <div class="question__answer-img-block">
                                    <img src="./img/q1-1.png" alt="">
                        ...
                        <div class="question__block-sizes" id="kutova">
                            ...
                            <div>
                                <label>
                                    <input type="text" class="q2_4"><span> см</span>
                                </label>
                                <div class="question__answer-img-block">
                                    <img src="./img/q1-2.png" alt="">
                                </div>
                        ...
                        <div class="question__block-sizes" id="p-podibna">
                            ...
                            <div>
                                ...
                                <label id="label-q2_3">
                                    <input type="text" class="q2_2" name="q2_2"><span> см</span>
                                </label>
                            </div>
                        </div>
                        <div class="question__block-sizes" id="ostrivna">
                            ...
                            <div>
                                <label>
                                    <input type="text" class="q2_2"><span> см</span>
                                </label>
                                <div class="question__answer-img-block">
                                    <img src="./img/q1-4.png" alt="">
                                </div>
                    ...
                    <div class="question__buttons">
                        <a class="question__buttons-prev"><span>Назад</span></a>
                        <a class="question__buttons-next"><span>Далі</span></a>
                    </div>
                </div>
            </div>
            ...
            <div class="question question--sixth">
                <div class="question__title-block">
                    <p>6. Оберіть свій подарунок до замовленої кухні!</p>
                    <div></div>
                </div>
                <div class="question__toggle-block">
                    <div class="question__block">
                        <ul>
                            ...
                            <li class="question__answer" data-answer="Комплект девайсів">
                                <p>Комплект девайсів</p>
                                <img src="./img/q6-3.png" alt="">
                            </li>
                        </ul>
                    </div>
                    <div class="question__buttons">
                        <a class="question__buttons-calculate"><span>Розрахувати вартість</span></a>
                    </div>
                </div>
            </div>
 ...
 <?php include_once "footer.php"; ?>    
   ...
   <div class="calculate-modal modal__overlay">
        <div class="calculate-modal-block modal__block">              
            ...
            <form class="form">
			<h4>Залиште контакти</h4>
Менеджер зателефонує протягом 30 хвилин. Уточнить деталі та розрахує вартість проекту.
                <p><input type="text" name="name" class="name" placeholder="Ваше ім'я" required>
                ...
                <input type="hidden" name="q6_answer" id="q6_answer" value="без відповіді"></p>
          <div class="modal__close"></div>  </form>
        </div>
    </div>

    <div class="project-modal modal__overlay"><div class="project-modal-block modal__block">
                    <form id="ajax-contact-form" enctype="multipart/form-data" method="post" class="form">
					<h4>Чудово!</h4>
Менеджер зателефонує протягом 30 хвилин. Уточнить деталі та розрахує вартість проекту.
                <p><input id="nameFF" name="nameFF" type="text" placeholder="Ваше ім'я" required>
                <input id="telFF" name="telFF" type="tel" placeholder="Ваш телефон" required>
                <input id="fileFF" name="fileFF" type="file">
                <input class="btn" type="submit" id="submitFF" value="Надіслати проект" onclick="ga('send', 'event', 'project', 'send')"></p>
            <div class="modal__close"></div> </form>
        </div></div>
   </body>
</html>
